          ...
          <div class="mdl-card__supporting-text mdl-color-text--grey-600">
            ...
            <form id="message-form" action="#">
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <textarea  class="mdl-textfield__input" type="text" id="message">&#13;&#10;&#13;&#10; URL: {{$url}}&#13;&#10; Report: {{$report}} </textarea>
                <br>
...
<script>
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyDEqeQceEJ1EetiUSppcn6KFqPHitbR7mU",
    authDomain: "ileap-69f2c.firebaseapp.com",
    databaseURL: "https://ileap-69f2c.firebaseio.com",
    storageBucket: "ileap-69f2c.appspot.com",
    messagingSenderId: "15554518246"
  };
  firebase.initializeApp(config);
</script>
<script>var ileapcode = '{{$ileapcode}}';</script>
